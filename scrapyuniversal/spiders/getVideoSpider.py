...
class GetVideoSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        # yield scrapy.Request('https://www.facebook.com/1182695138551955/posts/384224595692538',callback=self.parse)
    ...
    def parse(self, response):
        ...
        if response.status == 200:
            ...
            if str_contents:
                ...
                self.client_redis.lpush(ADS_VIDEO + '_error', response.url)
            else:
